...
class SpriteComponent: public Component {
  ...
  public:
      ...
      void Update (float deltaTime) override {
        ...
        destinationRectangle.x = static_cast<int>(transform -> position.x) - (isStatic ? 0: Game::camera.x);
        destinationRectangle.y = static_cast<int>(transform -> position.y) - (isStatic ? 0: Game::camera.y);
